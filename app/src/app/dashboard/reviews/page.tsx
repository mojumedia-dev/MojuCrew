  ...
  },
  {
    ...
    render: (data, update) => (
      <div className="space-y-5">
        ...
        <button
          type="button"
          onClick={() => update({ googleConnected: true })}
        ...
        {!!data.googleConnected && (
          <div className="bg-green-50 border border-green-100 rounded-lg p-4 text-sm text-green-700">
            MojuReviews will start monitoring your reviews and responding automatically based on your settings.
          </div>
        )}
        <div className="bg-gray-50 border border-gray-100 rounded-lg p-4 text-xs text-gray-500">
          Full Google OAuth integration launches with your subscription. This connects your account securely — we never store your Google password.
        </div>
      </div>
    ),
  },
